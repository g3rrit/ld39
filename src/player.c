...
Player player={.pbody=NULL,.asprite=NULL,.normal=NULL,.rotation=0,.rotationR=0,.vel=100.0,.x=100,.y=100,.w=32,.h=32,.init=&__Player_init,.update=&__Player_update,.draw=&__Player_draw,.delete=&__Player_delete};
void __Player_init()
{
